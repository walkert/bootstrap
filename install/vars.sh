base_packages_all=(curl fontconfig gcc git make wget unzip xz-utils)
nix_env_packages=(efm-langserver fzf lua-language-server neovim pyright python310Packages.virtualenv python310Packages.virtualenvwrapper python310Packages.pipx python310Packages.ipython ripgrep terraform-ls tmux)
