# Generated by Powerlevel10k configuration wizard on 2020-10-20 at 20:10 EDT.
...
() {
  ...
  typeset -g POWERLEVEL9K_RIGHT_PROMPT_ELEMENTS=(
    # =========================[ Line #1 ]=========================
    # jstatus                  # exit code of the last command
  ...
  function my_git_formatter() {
    ...
    if (( $1 )); then
      ...
      local      clean='%178F'   # green foreground
      #local      clean='%76F'   # green foreground
      local   modified='%002F'  # yellow foreground
